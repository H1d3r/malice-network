...
- [AI Agent 集成](agent.md) - MCP、Poison、Tapping、Skill 机制
...
| Execute | `exec` / `shell` / `powershell` / `bof` / `inline_exe` / `execute_assembly` | [命令执行](../operations/post-exploitation/command-execution.md) |
